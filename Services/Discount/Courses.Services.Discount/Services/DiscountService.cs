...
namespace Courses.Services.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<Response<NoContent>> Delete(int id)
        {
            ...
            return status > 0 ? Response<NoContent>.Success(204) : Response<NoContent>.Fail("Data bulunamadı", 404);
        }
        ...
        public async Task<Response<Models.Discount>> GetByCodeAndUserId(string code, string userId)
        {
            ...
            if (hasDiscount == null)
            {
                return Response<Models.Discount>.Fail("Tanımlı kod bulunamadı", 204);
            }
        ...
        public async Task<Response<Models.Discount>> GetById(int id)
        {
            ...
            if (discount == null)
            {
                return Response<Models.Discount>.Fail("indirim kodu bulunamadı", 404);
            }
        ...
        public async Task<Response<NoContent>> Update(Models.Discount discount)
        {
            ...
            return Response<NoContent>.Fail("Böyle bir data bulunamadı", 404);
        }
    }
}